...
const en: Translations = {
  ...
  getStarted: {
    heading: "Three phases. You're live in 3 weeks.",
    subheading: "How to get started with Hana.",
    step1Number: "PHASE 01",
    step1Title: "Pick the workflow.",
    step1Body: "The one that's costing you most — pre-built, or built around your protocols.",
    step2Number: "PHASE 02",
    step2Title: "Connect your EHR.",
    step2Body: "Direct, or 95+ systems via Redox. Hana reads the chart and your protocols first — patients are never asked what you already know.",
    step3Number: "PHASE 03",
    step3Title: "Go live — then it runs itself.",
    step3Body: "Your team tests it on a real line before a single patient is called. From there, Hana works the queue in the background — your team steps in only when it's flagged.",
    cta: "Book a Demo",
  ...
  howHanaWorks: {
    ...
    tab2: "Getting Started",
    tab2SubHeading: "Your First Week with HANA",
    tab2Body: "Watch the agent run, catch an emergency, and get smarter — in real time.",
    tab2f1: "Test your agents",
    tab2f2: "Create workflows",
    tab2f3: "Observability",
  ...
  integrations: {
    ...
    body: "95+ EHRs, reads and writes back automatically. Reaches patients by voice, SMS, WhatsApp, or iMessage, in 30+ languages.",
...
const it: Translations = {
  ...
  getStarted: {
    heading: "Tre fasi. Sei operativo in 3 settimane.",
    ...
    step2Body: "Integrazione diretta, o 95+ sistemi tramite Redox. Hana legge prima la cartella e i tuoi protocolli — al paziente non viene mai chiesto quello che sai già.",
    step3Number: "FASE 03",
    step3Title: "Parti live — poi va da sé.",
    step3Body: "Il tuo team testa l'assistente su una linea reale prima che venga contattato un solo paziente. Da lì, Hana lavora la coda in background — il tuo team interviene solo quando viene segnalato.",
  ...
  howHanaWorks: {
    ...
    tab2: "Per Iniziare",
    tab2SubHeading: "La Tua Prima Settimana con HANA",
    tab2Body: "Guarda l'agente in azione, intercettare un'emergenza e diventare più intelligente — in tempo reale.",
    tab2f1: "Prova i tuoi agenti",
    tab2f2: "Crea i flussi",
    tab2f3: "Osservabilità",
  ...
  integrations: {
    ...
    body: "95+ EHR, legge e scrive automaticamente. Raggiunge i pazienti tramite voce, SMS, WhatsApp o iMessage, in 30+ lingue.",
