...
const it: Translations = {
  ...
  footer: {
    tagline: "Automatizza la routine. Libera il tuo team.",
    ...
    blog: "Blog",
    labs: "Laboratorio",
    stateOfVoiceAI: "Stato della Voice AI",
    useCases: "Casi d'Uso",
    company: "Azienda",
    pricing: "Prezzi",
    aboutUs: "Chi Siamo",
    ...
    acceptableUsePolicy: "Policy di Utilizzo Accettabile",
  ...
  getStarted: {
    ...
    subheading: "Come iniziare con Hana.",
    step1Number: "001",
    step1Title: "Scegli il workflow.",
    step1Body: "Quello che ti costa di più — già pronto, o costruito attorno ai tuoi protocolli.",
    step2Number: "002",
    step2Title: "Connetti il tuo EHR.",
    step2Body: "Diretto, o 95+ sistemi tramite Redox e Catagon. Legge prima la cartella — ai pazienti non viene mai chiesto ciò che già sai.",
    step3Number: "003",
    step3Title: "Vai live.",
    step3Body: "Il tuo team lo testa su una linea reale prima che venga chiamato un solo paziente.",
    cta: "Prenota una Demo",
    note: "La maggior parte dei team va live in 3 settimane.",
  },
  cta: {
    heading: "Automatizza la routine. Libera il tuo team.",
    body: "Prenota una demo. Ti mostreremo un workflow costruito per come lavora il tuo team — non un tour di prodotto generico.",
    bookDemo: "Prenota una Demo",
    savings: "Scopri quanto puoi risparmiare",
  ...
  liveDemo: {
    heading: "Non fidarti solo di noi. Rispondi alla chiamata.",
    subheading: "Lascia il tuo numero e Hana ti chiama adesso — l'agente capisce la demo giusta mentre parli.",
    listeningLabel: "Hana sta ascoltando",
    formHeading: "Ascolta Hana gestire una vera conversazione con un paziente.",
    formSubheading: "Inserisci i tuoi dati e Hana ti manda prima un messaggio di conferma, poi ti chiama in pochi secondi — per vivere l'AI dal vivo.",
    nameLabel: "Nome",
  ...
  caseStudiesTeaser: {
    tag: "Casi Studio",
    heading: "I risultati parlano.",
    body: "Scopri come i team hanno affidato la routine a Hana — e cosa è cambiato.",
    readMore: "Leggi i casi studio",
    readMoreSub: "Deployment completi — con agenti vocali live che puoi provare.",
  },
  recipesMarquee: {
