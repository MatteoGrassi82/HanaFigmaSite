...
function CardHeader({ c }: { c: CaseStudy }) {
  return (
    <>
      ...
      <div className="font-serif text-[19px] leading-[1.1] mb-1 text-slate-900">{c.title}</div>
...
function BottomCTA() {
  return (
    <div className="mt-12 p-6 border border-slate-200 flex items-center justify-between gap-6 flex-wrap">
      <div>
        <div className="font-serif text-[20px] leading-[1.1] mb-1">
    ...
    <div className="max-w-5xl mx-auto px-6">
      ...
      <div className="grid grid-cols-[3fr_2fr] max-[580px]:grid-cols-1 gap-9 mb-9 pb-8 border-b border-slate-200">
        <div>
          ...
          <h1 className="font-serif text-[clamp(22px,3.5vw,34px)] font-normal leading-[1.1] tracking-normal mb-1">
            {c.title}
          </h1>
      ...
      <div className="mt-12 p-6 border border-slate-200 flex items-center justify-between gap-6 flex-wrap">
        <div>
          <div className="font-serif text-[20px] leading-[1.1] mb-1">See this workflow in action.</div>
          <div className="text-[13px] text-slate-600">
