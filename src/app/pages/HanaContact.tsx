...
const FAQS = [
  ...
  },
  {
    ...
    a: "HANA handles calls in 30+ languages, switching automatically based on the caller. No separate lines or configuration required.",
  },
  {
  ...
  return (
    <div className="bg-white text-[#00122F] font-sans overflow-x-hidden">
      <SEO
        ...
        useExactTitle
        type="product"
        description="HANA Contact handles every inbound call, outreach, and patient follow-up your team doesn't have time for: automatically, in 30+ languages, 24/7, and directly inside your EHR."
        path="/hana-contact"
...
const PIPELINE_STAGES = [
  {
    key: "Answer",
    short: "Picks up every call, text, and transfer instantly, in 30+ languages, 24/7.",
    detail:
