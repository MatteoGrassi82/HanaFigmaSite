...
//
// NOTE (2026-08-13): the shader code is untouched, but the UNIFORMS recipe below
// was retuned for the HANA hero — see the comment on that block. If you re-paste
// a fresh recipe from the builder, you'll lose that tuning.
 ...
 *  - saturation: 2.0 → 1.15, so the authored colours render close to as authored.
 *  - grain: 0.35 → 0.10. The heavy grain read as noise over the UI.
 *  - the top of the ramp stops at a pale blue-grey rather than near-white, so
